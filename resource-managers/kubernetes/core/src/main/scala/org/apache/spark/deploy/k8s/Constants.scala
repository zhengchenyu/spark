...
object Constants {
  ...
  // Suffix for the dedicated Spark Web UI Service (see KUBERNETES_DRIVER_UI_SERVICE_ENABLED).
  // The service name will be <resourceNamePrefix> + DRIVER_UI_SVC_POSTFIX.
